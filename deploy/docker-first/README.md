...
This deploy directory must contain deploy assets only. Do not keep real runtime files here:
...
For production, copy the templates to the Compose working directory `/www/docker/admin-go-backend/` and edit the copies there.
