...
> **For agentic workers:** REQUIRED SUB-SKILL: Use `superpowers:executing-plans` to implement this plan task-by-task directly on the existing `master` checkouts. Do not create a worktree or use browser automation. Steps use checkbox (`- [ ]`) syntax for tracking.
...
- [ ] **Step 1: Change deployment tests to require Node 24.18.0**
...
- [ ] **Step 2: Run the focused Docker test and observe RED**
...
- [ ] **Step 3: Update runtime truth and lock metadata**
...
- [ ] **Step 4: Rebuild the Node 24 performance baseline and verify GREEN**
...
- [ ] **Step 1: Write failing lifecycle and lock contract tests**
...
- [ ] **Step 2: Run the PowerShell test and observe RED**
...
- [ ] **Step 3: Implement the shared lock primitives**
...
- [ ] **Step 4: Implement `dev-state` and guards**
...
- [ ] **Step 4: Add separate Air configurations**
...
- [ ] **Step 1: Add failing supervisor source/fixture tests**
...
- [ ] **Step 3: Implement `admin-dev.ps1`**
...
- [ ] **Step 4: Verify failure and cleanup fixtures**
...
- [ ] **Step 1: Write failing idempotent Profile tests**
...
- [ ] **Step 2: Implement and verify the installer**
...
- [ ] **Step 3: Correct the execution index**
...
- [ ] **Step 2: Install shortcuts and start local development**
...
- [ ] **Step 5: Final clean-state audit**
