...
- [ ] **Step 2: 抽出唯一 Redis Publisher 构造点**
...
- [ ] **Step 3: 运行 backend Realtime 定向测试**
...
- [ ] **Step 5: 运行前端 Realtime 定向测试和 ESLint**
...
- [ ] **Step 6: 提交 backend/frontend Task 2**
