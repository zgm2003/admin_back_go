...
**日期：** 2026-07-18
**状态：** 已归档并被 2026-07-19 Browser-only 决策整体 supersede；禁止据此继续执行
**范围：** P07、P08、P08.5、P09 的历史 Tauri 时代重基线

> **当前唯一有效的后续规格：** `2026-07-19-admin-browser-only-tauri-retirement-design.md`。
> 本文保留用于解释 P08 为什么曾经实施以及 P08.5 为什么曾经被规划；其中关于 Tauri、Windows candidate、GitHub Workflow、P08.5 和旧 P09 发布单元的内容全部为历史记录，不再是当前契约。

当前固定执行顺序是：

```text
P08R Browser-only/Tauri 完整退役
→ 用户阶段性功能验收
→ 修订后的 P07 Tasks 6–10
→ 用户阶段性功能验收
→ 修订后的 P09
