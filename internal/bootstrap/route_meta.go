...
func permissionRouteRules() map[middleware.RouteKey]string {
	return map[middleware.RouteKey]string{
		...
		middleware.NewRouteKey(http.MethodPut, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id"):          "ai_knowledge_document_edit",
		middleware.NewRouteKey(http.MethodDelete, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id"):       "ai_knowledge_document_del",
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id/reindex"): "ai_knowledge_reindex",
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases/:id/retrieval-test"):                 "ai_knowledge_retrieval_test",
	}
}
...
func operationRouteRules() map[middleware.RouteKey]middleware.OperationRule {
	return map[middleware.RouteKey]middleware.OperationRule{
		...
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-agents"):                                             {Module: "ai_agent", Action: "create", Title: "新增AI智能体"},
		middleware.NewRouteKey(http.MethodPut, "/api/admin/v1/ai-agents/:id"):                                          {Module: "ai_agent", Action: "update", Title: "编辑AI智能体"},
		middleware.NewRouteKey(http.MethodPatch, "/api/admin/v1/ai-agents/:id/status"):                                 {Module: "ai_agent", Action: "change_status", Title: "修改AI智能体状态"},
		middleware.NewRouteKey(http.MethodDelete, "/api/admin/v1/ai-agents/:id"):                                       {Module: "ai_agent", Action: "delete", Title: "删除AI智能体"},
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases"):                                    {Module: "ai_knowledge", Action: "create", Title: "新增知识库"},
		middleware.NewRouteKey(http.MethodPut, "/api/admin/v1/ai-knowledge-bases/:id"):                                 {Module: "ai_knowledge", Action: "update", Title: "编辑知识库"},
		middleware.NewRouteKey(http.MethodPatch, "/api/admin/v1/ai-knowledge-bases/:id/status"):                        {Module: "ai_knowledge", Action: "change_status", Title: "修改知识库状态"},
		middleware.NewRouteKey(http.MethodDelete, "/api/admin/v1/ai-knowledge-bases/:id"):                              {Module: "ai_knowledge", Action: "delete", Title: "删除知识库"},
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases/:id/documents"):                      {Module: "ai_knowledge_document", Action: "create", Title: "新增知识库文档"},
		middleware.NewRouteKey(http.MethodPut, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id"):          {Module: "ai_knowledge_document", Action: "update", Title: "编辑知识库文档"},
		middleware.NewRouteKey(http.MethodDelete, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id"):       {Module: "ai_knowledge_document", Action: "delete", Title: "删除知识库文档"},
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases/:id/documents/:document_id/reindex"): {Module: "ai_knowledge_document", Action: "reindex", Title: "重建知识库索引"},
		middleware.NewRouteKey(http.MethodPost, "/api/admin/v1/ai-knowledge-bases/:id/retrieval-test"):                 {Module: "ai_knowledge", Action: "retrieval_test", Title: "知识库召回测试"},
