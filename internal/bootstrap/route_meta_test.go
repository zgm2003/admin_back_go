...
func TestPermissionRouteRulesUseExplicitRESTPatterns(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPost, "/api/admin/v1/ai-agents/:id/bindings", "ai_agent_binding_add"},
		{http.MethodDelete, "/api/admin/v1/ai-agent-bindings/:id", "ai_agent_binding_del"},
	...
	for _, tt := range []struct {
		...
		{http.MethodGet, "/api/admin/v1/ai-agents/:id/bindings"},
...
func TestOperationRouteRulesUseExplicitRESTPatterns(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPost, "/api/admin/v1/ai-agents/:id/bindings", "create"},
		{http.MethodDelete, "/api/admin/v1/ai-agent-bindings/:id", "delete"},
