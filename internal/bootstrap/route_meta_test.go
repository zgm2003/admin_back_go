...
func TestPermissionRouteRulesUseExplicitRESTPatterns(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPut, "/api/admin/v1/sms/config", "system_sms_configEdit"},
		{http.MethodDelete, "/api/admin/v1/sms/config", "system_sms_configDel"},
		{http.MethodPost, "/api/admin/v1/sms/test", "system_sms_test"},
		{http.MethodPost, "/api/admin/v1/sms/templates", "system_sms_templateAdd"},
		{http.MethodPut, "/api/admin/v1/sms/templates/:id", "system_sms_templateEdit"},
		{http.MethodPatch, "/api/admin/v1/sms/templates/:id/status", "system_sms_templateStatus"},
		{http.MethodDelete, "/api/admin/v1/sms/templates/:id", "system_sms_templateDel"},
		{http.MethodDelete, "/api/admin/v1/sms/logs/:id", "system_sms_logDel"},
		{http.MethodDelete, "/api/admin/v1/sms/logs", "system_sms_logDel"},
		...
		{http.MethodPost, "/api/admin/v1/ai-providers/:id/model-options", "ai_provider_test"},
...
func TestOperationRouteRulesUseExplicitRESTPatterns(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPut, "/api/admin/v1/mail/config", "update_config"},
		{http.MethodDelete, "/api/admin/v1/mail/config", "delete_config"},
		{http.MethodPost, "/api/admin/v1/mail/test", "test_send"},
		{http.MethodPost, "/api/admin/v1/mail/templates", "create_template"},
		{http.MethodPut, "/api/admin/v1/mail/templates/:id", "update_template"},
		{http.MethodPatch, "/api/admin/v1/mail/templates/:id/status", "change_template_status"},
		{http.MethodDelete, "/api/admin/v1/mail/templates/:id", "delete_template"},
		{http.MethodDelete, "/api/admin/v1/mail/logs/:id", "delete_log"},
		{http.MethodDelete, "/api/admin/v1/mail/logs", "delete_logs"},
		{http.MethodPut, "/api/admin/v1/sms/config", "update_config"},
		{http.MethodDelete, "/api/admin/v1/sms/config", "delete_config"},
		{http.MethodPost, "/api/admin/v1/sms/test", "test_send"},
		{http.MethodPost, "/api/admin/v1/sms/templates", "create_template"},
		{http.MethodPut, "/api/admin/v1/sms/templates/:id", "update_template"},
		{http.MethodPatch, "/api/admin/v1/sms/templates/:id/status", "change_template_status"},
		{http.MethodDelete, "/api/admin/v1/sms/templates/:id", "delete_template"},
		{http.MethodDelete, "/api/admin/v1/sms/logs/:id", "delete_log"},
		{http.MethodDelete, "/api/admin/v1/sms/logs", "delete_logs"},
		...
		{http.MethodPost, "/api/admin/v1/ai-providers/:id/model-options", "preview_models"},
