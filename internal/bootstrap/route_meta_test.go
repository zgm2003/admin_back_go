...
func TestPermissionRouteRulesUseExplicitRESTPatterns(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{http.MethodGet, "/api/admin/v1/chat/contacts"},
		{http.MethodPost, "/api/admin/v1/chat/contacts/:user_id/requests"},
		{http.MethodPatch, "/api/admin/v1/chat/contacts/:user_id/confirm"},
		{http.MethodDelete, "/api/admin/v1/chat/contacts/:user_id"},
