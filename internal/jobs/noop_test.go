...
func TestNewRegistryOwnsEveryCurrentVersionedTask(t *testing.T) {
	...
	want := []string{
		...
		contextengine.TaskContextMemoryBuildV1,
	...
	policies := []struct {
		...
		{contextengine.TaskContextMemoryBuildV1, taskqueue.QueueLow, ContextMemoryBuildMaxRetry, ContextMemoryBuildTimeout, 0},
