...
func createInput(req mutationRequest) aiprovidermodule.CreateInput {
	return aiprovidermodule.CreateInput{Name: req.Name, EngineType: req.EngineType, BaseURL: req.BaseURL, APIKey: req.APIKey, ModelIDs: req.ModelIDs, ModelDisplayNames: req.ModelDisplayNames, Status: req.Status}
}
