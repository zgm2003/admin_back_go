...
func TestLockedPlanAuthorityRejectsLostLeaseCancelAndTerminalRun(t *testing.T) {
	...
	run := lockedAuthorityRun{ID: 44, RequestID: "request-1", UserID: 7, Status: enum.AIRunStatusRunning, ConversationID: int64Pointer(3), UserMessageID: int64Pointer(9)}
	command := lockedReplyCommand{ID: 77, RequestID: "request-1", UserID: 7, ConversationID: 3, UserMessageID: 9, State: "running", LeaseOwner: &owner, LeaseToken: 3, LeaseExpiresAt: &expires}
