...
type listRequest struct {
	...
	Modality    string `form:"modality" binding:"omitempty,oneof=chat text image video"`
	SourceType  string `form:"source_type" binding:"omitempty,oneof=ai_chat_message ai_text_task ai_image_task canvas_video_task"`
	UsageStatus string `form:"usage_status" binding:"omitempty,oneof=pending reported unavailable"`
