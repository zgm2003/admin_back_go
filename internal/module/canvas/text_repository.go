...
type TextGormRepository struct{ db *gorm.DB }

func NewTextGormRepository(client *database.Client) *TextGormRepository {
	if client == nil || client.Gorm == nil {
		return nil
	}
	return &TextGormRepository{db: client.Gorm}
}

func (r *TextGormRepository) AgentForTextRuntime(ctx context.Context, agentID int64) (*TextAgentRuntime, error) {
	if r == nil || r.db == nil {
