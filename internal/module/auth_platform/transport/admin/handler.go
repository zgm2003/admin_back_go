...
type HTTPService interface {
	PageInit(ctx context.Context) (*authplatformmodule.InitResponse, *apperror.Error)
	List(ctx context.Context, query authplatformmodule.ListQuery) (*authplatformmodule.ListResponse, *apperror.Error)
	Create(ctx context.Context, input authplatformmodule.CreateInput) (int64, *apperror.Error)
	Update(ctx context.Context, id int64, input authplatformmodule.UpdateInput) *apperror.Error
...
func (h *Handler) List(c *gin.Context) {
	...
	result, appErr := h.service.List(c.Request.Context(), authplatformmodule.ListQuery{
...
func bindCreate(c *gin.Context) (authplatformmodule.CreateInput, bool) {
	var req createRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.Error(c, apperror.BadRequestKey("authplatform.create.request.invalid", nil, "参数错误"))
		return authplatformmodule.CreateInput{}, false
	}
...
func bindUpdate(c *gin.Context) (authplatformmodule.UpdateInput, bool) {
	var req updateRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.Error(c, apperror.BadRequestKey("authplatform.update.request.invalid", nil, "参数错误"))
		return authplatformmodule.UpdateInput{}, false
	}
